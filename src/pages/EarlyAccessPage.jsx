                ...
                <div className="space-y-6 text-center">
                  ...
                  >
                    ...
                    <ol className="space-y-1.5 list-decimal list-inside text-surface-600">
                      ...
                      <li>Scan a QR code in the email and pay the exact amount shown</li>
                      <li>Take a screenshot of your successful payment</li>
                      <li>
                        Send the screenshot on WhatsApp to{' '}
                        <strong>{formatWhatsAppNumber(signupOrder.whatsappNumber)}</strong>
                      </li>
                    </ol>
                  </div>

                  {signupOrder.whatsappUrl && (
                    <a
                      href={signupOrder.whatsappUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 w-full rounded-xl bg-[#25D366] hover:bg-[#1ebe57] text-white font-semibold py-3.5 px-4 transition-colors animate-fade-in-up opacity-0"
                  ...
                  <p className="text-sm text-surface-500 animate-fade-in-up opacity-0" style={{ animationDelay: '320ms' }}>
                    We&apos;ll verify your payment manually and activate your account within 24 hours.
                  </p>
